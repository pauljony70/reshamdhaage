						...
						<div class="card-body">
							<div class="form-three widget-shadow">
								...
								<form class="form-horizontal" id="myform">
									...
									<div class="col-sm-offset-2">
										<button type="submit" class="btn btn-dark" href="javascript:void(0)" onclick="addBusiness(this); return false;">Save</button>
									</div>
						...
						<div class="card-body">
							<div class="form-three widget-shadow">
								...
								<form class="form-horizontal" id="website_settings">
									...
									<div class="form-group row">
										<label for="focusedinput" class="col-sm-2 control-label">Facebbok Link</label>
										<div class="col-sm-8">
									...
									<div class="col-sm-offset-2">
										<button type="submit" class="btn btn-dark" href="javascript:void(0)" onclick="updateWebsiteSetting(); return false;">Save</button>
									</div>
						...
						<div class="card-body">
							<div class="form-three widget-shadow">
								...
								<form class="form-horizontal" id="scriptform">
									<div class="form-group row">
										<label for="focusedinput" class="col-sm-2 control-label">GTag Manager</label>
										<div class="col-sm-8">
									...
									<div class="col-sm-offset-2">
										<button type="submit" class="btn btn-dark" href="javascript:void(0)" onclick="updateSetting(); return false;">Save</button>
									</div>
