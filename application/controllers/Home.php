...
class Home extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['home_section2'] = $this->home_model->get_header_banner_request('section2','1920-680');
		$this->data['home_section4'] = $this->home_model->get_header_banner_request('section4','1930-150');
		$this->data['home_section5'] = $this->home_model->get_header_banner_request('section5','1900-320');
		$this->data['new_product'] = $this->home_model->get_home_products('New');
		$this->data['popular_product'] = $this->home_model->get_home_products('Popular');
