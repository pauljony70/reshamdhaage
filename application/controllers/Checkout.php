...
class Checkout extends CI_Controller
{
    ...
    public function view()
    {
        ...
        if (!empty($data['cartdetails']['Information']['prod_details']))
    ...
    function placeorder()
    {
        ...
        $securecode = $_REQUEST['securecode'];
        $user_id = $_REQUEST['user_id'];
        $paymentorder_id = $_REQUEST['paymentorder_id'];
        ...
        $customer_pincode = $_REQUEST['customer_pincode'];
        $total_price = $_REQUEST['total_price'];
        $qoute_id = $_REQUEST['qoute_id'];
        $deliverymode = $_REQUEST['deliverymode'];
        $extraship = $_REQUEST['extraship'];
        $deliveryid = $_REQUEST['deliveryid'];
        $walletcoins = $_REQUEST['walletcoins'];
        ...
        $response = $this->checkout_model->placeorder($language, $securecode, $user_id, $paymentorder_id, $payment_id, $address_id, $customer_name, $customer_email, $customer_phone, $customer_address, $customer_city, $customer_state, $customer_pincode, $total_price, $qoute_id, $deliverymode, $extraship, $deliveryid, $walletcoins, $discountvalue, $discountid, $shipping);
        echo json_encode($response);
    }
    ...
    function getuseraddress()
    {
        ...
        $response = $this->checkout_model->get_address($language, $securecode, $user_id);
        echo json_encode($response);
    }
