...
class Order_model extends CI_Model
{
	...
	public function getorderhistory($langauge, $securecode, $user_id)
	{
		$orderid = "";
		$address = "";
		$price = "";
	...
	function getorderhistorydetails($langauge, $securecode, $user_id, $order_id)
	{
		$orderid = "";
		$address = "";
		$price = "";
	...
	public function getorderdetails($user_id, $order_id)
	{
		...
		$order_prods_details = $this->db->get_where('order_product', array('order_id' => $order_id, 'user_id' => $user_id))->result_array();
		$order = [
			'order_details' => $order_details,
			'order_prods_details' => $order_prods_details,
		];
		return $order;
	}
}
